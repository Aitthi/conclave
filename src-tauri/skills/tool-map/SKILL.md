...
| Browser | `conclave browser screenshot [path] [--width N] [--height N]` | capture the current page to a PNG (macOS; path defaults to ./browser-screenshot.png) — returns the file path, Read it to see the pixels |
