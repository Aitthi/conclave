...
6. **No frontend edits.** If the implementer finds the frontend must change to make the live repro pass, that is a `task challenge` with the evidence, not a silent boundary widening.
